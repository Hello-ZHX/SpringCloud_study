...
public enum ReturnCodeEnum {
    ...
    public static ReturnCodeEnum getReturnCodeEnumForStream(String code){
...
/*    public static void main(String[] args) {
        ...
        System.out.println(getReturnCodeEnumForStream("404"));
        System.out.println(getReturnCodeEnumForStream("404").getCode());
        System.out.println(getReturnCodeEnumForStream("404").getMessage());
    }*/
}
